...
from exam.teacher import models as TMODEL
from exam.student import models as SMODEL
from exam.teacher import forms as TFORM
from exam.student import forms as SFORM
...
@login_required(login_url='adminlogin')
def view_result_pupils(request, pk):
    result_pupil = Result.objects.all().filter(exam_id=pk)
    return render(request, 'exam/result_pupil.html', {'result_pupil': result_pupil})